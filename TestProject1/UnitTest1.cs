...
namespace TestProject1
{
    public class WeatherForecastControllerTest
    {
        ...
        public void ConvertResponseToWeatherForecastTest()
        {
            ...
            // Assert
            WeatherForecast weatherForecastForTomorrow = ((WeatherForecast[])output)[1];
        ...
        [Fact]
        public void ConvertResponseToWeatherForecastTestOtherDay()
        {
            // Assume
            var content = LoadJsonFromResource();
            var controller = new WeatherForecastController();
